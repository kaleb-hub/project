...
<html>
    ...
    <body>
        ...
        <div class="container1">
		    <p>ሴክተሩ በዞኑ ያሉትን ሰብዓዊና ተፈጥሯዊ ሀብቶችን አቀናጅቶ በመምራት ቀጣይነት ባለዉ መልኩ በስፋት ጥቅም ላይ በማዋልና
            በማጠናከር ማህበራዊና ኢኮኖሚያዊ ልማትን በማፋ ጠን እና መልካም አስተዳደርና ዲሞክራሲያዊ ስርዓት ግንባታ እንዲጎለብት ማድረግ፡፡<br>
          <a href="admin_Page.php">Back</a></p>
          ...
          <div class="Footer_top">
            ...
            <div class="footer_left2">
                <ul style="list-style-type: none">
                    ...
                    <li><a href="image.php" target="_parent" >FEDERAL</a></li>
                </ul>
            </div>
