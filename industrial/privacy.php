    ...
    <body>
        ...
        <div class="topnav" id="myTopnav">
            ...
            <li class="hover-me"><a href="">gombora</a><img class="imgi" src="download (2).png" width="10" height="10"></i>
             ...
             <li class="hover-me"><a href="">SHAHSHOGO</a><img class="imgi" src="download (2).png" width="10" height="10"></i>
                ...
                <div class="sub-menu-2">
                    <ul>
                     <li><a href="kode.html">gombora</a></li>
                     <li><a href="kode.html">Ambicho</a></li>
                     <li><a href="kode.html">hadiya</a></li>
                      <li><a href="kode.html">Hossana</a></li>
                    </ul>
                </div>
            </li>
        ...
        <div class="container">
            <div class="privacy">
                <p>PRIVACY POLICY</p>
                 <ul>
                     <li>user can use this system without login</li>
                      <li>user can use this system without login</li>
                       <li>user can't login into the system as admin</li>
                        <li>only admin can update the system</li>
                         <li>No one can update the admin info except admin him self.</li>
                 </ul>
                 <a href="user.html">BACK</a></p>
           </div>
        </div>
